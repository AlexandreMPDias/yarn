...
function flatPkgScript(entry, base = '') {
  ...
  if (typeof entry === 'object') {
    for (var _iterator = Object.entries(entry), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      var _ref2;
...
class Config {
  ...
  init(opts = {}) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator2 = linkedModules, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        var _ref3;
      ...
      if (!cacheRootFolder) {
        ...
        for (var _iterator4 = cacheFolderQuery.skipped, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
          var _ref5;
  ...
  listUnpluggedPackageFolders() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator5 = yield (_fs || _load_fs()).readdir(unpluggedPath), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
        var _ref6;
  ...
  maybeReadManifest(dir, priorityRegistry, isRoot = false) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator6 = Object.keys((_index2 || _load_index2()).registries), _isArray6 = Array.isArray(_iterator6), _i7 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
        var _ref9;
  ...
  resolveWorkspaces(root, rootManifest) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (var _iterator8 = new Set([].concat(...files)), _isArray8 = Array.isArray(_iterator8), _i9 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();;) {
        var _ref11;
  ...
  saveRootManifests(manifests) {
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      for (var _iterator10 = (_index2 || _load_index2()).registryNames, _isArray10 = Array.isArray(_iterator10), _i11 = 0, _iterator10 = _isArray10 ? _iterator10 : _iterator10[Symbol.iterator]();;) {
        var _ref13;
        ...
        for (var _iterator11 = (_constants || _load_constants()).DEPENDENCY_TYPES, _isArray11 = Array.isArray(_iterator11), _i12 = 0, _iterator11 = _isArray11 ? _iterator11 : _iterator11[Symbol.iterator]();;) {
          var _ref14;
